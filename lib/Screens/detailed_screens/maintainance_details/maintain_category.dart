...
class MaintainCategoryScreen extends StatefulWidget {
  const MaintainCategoryScreen({super.key});

  @override
  State<MaintainCategoryScreen> createState() => _MaintainCategoryScreenState();
}

class _MaintainCategoryScreenState extends State<MaintainCategoryScreen> {
  List wo = [
    'assets/paint.jpg',
    'assets/main.jpg',
    'assets/tank.jpg',
