...
class PackersAndMoversDetailScreen extends StatefulWidget {
  const PackersAndMoversDetailScreen({super.key});

  @override
  State<PackersAndMoversDetailScreen> createState() =>
      _PackersAndMoversDetailScreenState();
}

class _PackersAndMoversDetailScreenState
    extends State<PackersAndMoversDetailScreen> {
