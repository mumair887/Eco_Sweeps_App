...
class PestControlcategorieScreen extends StatefulWidget {
  const PestControlcategorieScreen({super.key});

  @override
  State<PestControlcategorieScreen> createState() =>
      _PestControlcategorieScreenState();
}

class _PestControlcategorieScreenState
    extends State<PestControlcategorieScreen> {
  List wo = [
    'assets/dis.jpg',
    'assets/pest1.jpg',
  ];
