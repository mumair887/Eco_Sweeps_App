...
class RecoveryVehiclecategoryScreen extends StatefulWidget {
  const RecoveryVehiclecategoryScreen({super.key});

  @override
  State<RecoveryVehiclecategoryScreen> createState() =>
      _RecoveryVehiclecategoryScreenState();
}

class _RecoveryVehiclecategoryScreenState
    extends State<RecoveryVehiclecategoryScreen> {
  List wo = [
    'assets/ve1.jpg',
    'assets/ve2.jpg',
    'assets/ve3.jpg',
  ...
  List wodetail = [
    ...
    'Heavy Duty Towing and R',
    'Accident and Breakdown Ass',
  ];
  @override
